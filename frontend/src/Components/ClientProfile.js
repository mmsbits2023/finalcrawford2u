...
/*function handleSubmit(event) { 
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
      ...
      const response = await fetch("http://localhost:5050/client/updateClientDetails", {
        method: "POST",
        headers: {
      ...
      if (result.status === 422 || !data) {
        window.alert("Inavalid updated profile");
        console.log("Inavalid updated profile");
      }
      else {
  ...
  return (
    <div>
      ...
      <div className="container mt-3 shadow-lg p-3" >
        <h2 className="text-center">Client Profile</h2>
        ...
        <div className="mb-1 register">
          ...
          <div className="mb-1 register">
           ...
           <br/><br/>
           <div>
           <NavLink to="/clientLogout"> Logout</NavLink>
           </div>
